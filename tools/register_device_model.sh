...
# The input of this file is device_model.json file. Please fill your device model information into that file.
...
curl -s -k -X POST -H "Content-Type: application/json" \
    -H "Authorization: $TOKEN_TYPE $ACCESS_TOKEN" -d @device_model.json \
